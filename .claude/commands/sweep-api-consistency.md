...
Read `.claude/sweep-api-consistency-state.csv` per the state-CSV contract
...
5. After finishing (whether you found issues or not), update
   .claude/sweep-api-consistency-state.csv following the state-CSV
   contract in .claude/commands/_sweep-common.md (csv.DictReader/DictWriter
