...
Read `.codex/sweep-error-handling-state.csv` per the state-CSV contract in
...
5. After finishing, update .codex/sweep-error-handling-state.csv following
   the state-CSV contract in .codex/commands/_sweep-common.md. Header:
