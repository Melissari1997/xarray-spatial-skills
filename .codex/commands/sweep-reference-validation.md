...
Read `.codex/sweep-reference-validation-state.csv` per the state-CSV
...
6. After finishing, update .codex/sweep-reference-validation-state.csv
   following the state-CSV contract in .codex/commands/_sweep-common.md.
   Header:
