...
Read `.kilo/worktrees/sweep-documentation-state.csv` per the state-CSV contract in
...
5. After finishing (whether you found issues or not), update
   .kilo/worktrees/sweep-documentation-state.csv following the state-CSV contract in
   .kilo/command/_sweep-common.md (csv.DictReader/DictWriter pattern, one
