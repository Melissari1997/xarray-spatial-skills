...
Read `.kilo/worktrees/sweep-error-handling-state.csv` per the state-CSV contract in
...
5. After finishing, update .kilo/worktrees/sweep-error-handling-state.csv following
