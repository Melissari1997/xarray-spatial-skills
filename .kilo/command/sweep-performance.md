...
Read `.kilo/worktrees/sweep-performance-state.csv` per the state-CSV contract in
...
6. After finishing (whether you found issues or not), update
   `.kilo/worktrees/sweep-performance-state.csv` following the state-CSV contract
