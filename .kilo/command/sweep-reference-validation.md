...
Read `.kilo/worktrees/sweep-reference-validation-state.csv` per the state-CSV
...
6. After finishing, update .kilo/worktrees/sweep-reference-validation-state.csv
   following the state-CSV contract in .kilo/command/_sweep-common.md.
   Header:
